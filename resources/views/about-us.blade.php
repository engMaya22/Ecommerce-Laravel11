...
<main class="pt-90">
    ...
    <section class="container contact-us">
      ...
      <div class="pb-5 mb-5 about-us__content">
        <p class="mb-5">
          <img loading="lazy" class="h-auto w-100 d-block" src="assets/images/about/about-1.jpg" width="1410"
            height="550" alt="" />
        </p>
        <div class="mw-930">
          <h3 class="mb-4">OUR STORY</h3>
          <p class="mb-4 fs-6 fw-medium">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu
