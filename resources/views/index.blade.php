          ...
          <div class="swiper-slide">
            <div class="overflow-hidden position-relative h-100">
              <div class="bottom-0 slideshow-character position-absolute pos_right-center">
                <img loading="lazy" src="{{$slide->getImage}}"width="542" height="733"
                  alt="{{$slide->title}}"
              ...
              <div class="container slideshow-text position-absolute start-50 top-50 translate-middle">
                <h6 class="text_dash text-uppercase fs-base fw-medium animate animate_fade animate_btt animate_delay-3">
                  New Arrivals</h6>
                <h2 class="mb-0 h1 fw-normal animate animate_fade animate_btt animate_delay-5">{{$slide->title}}</h2>
        ...
        <div class="position-relative">
          <div class="swiper-container js-swiper-slider" data-settings='{
            ...
            @foreach ($categories as $category )
              ...
              <div class="swiper-slide">
                <img loading="lazy" class="h-auto mb-3 w-100" src="{{$category->getImage}}" width="124"
      ...
      <section class="container hot-deals">
        ...
        <div class="row">
          <div
            ...
            <a href="{{route('shop.index')}}" class="mt-3 btn-link default-underline text-uppercase fw-medium">View All</a>
          </div>
                    ...
                    <div class="swiper-slide product-card product-card_style3">
                        <div class="pc__img-wrapper">
                          <a href="{{ route('shop.product.view',['slug'=>$product->slug])}}">
                            <img loading="lazy" src="{{$product->getOrginalIImage}}"width="258" height="313"
