                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{$dashboradData[0]->TotalAmount}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{$dashboradData[0]->TotalOrdered}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{$dashboradData[0]->TotalOrderedAmount}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{$dashboradData[0]->TotalDelivered}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{$dashboradData[0]->TotalDeliveredAmount}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap14">
                                    ...
                                    <div>
                                        ...
                                        <h4>{{$dashboradData[0]->TotalCanceledAmount}}</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-wrap gap40">
                        ...
                        <div>
                            <div class="mb-2">
                                <div class="block-legend">
                                    <div class="dot t2"></div>
                                    <div class="text-tiny">Cancled</div>
                                </div>
                            </div>
                            <div class="flex items-center gap10">
            ...
            var chartBar = function () {
                ...
                var options = {
                    series: [{
                        ...
                        name: 'Pending',
                        data: [{{$totalOrderedAmountM}}]
                    },
                    {
                        name: 'Delivered',
                        data: [{{$totalDeliveredAmountM}}]
                    }, {
                        name: 'Canceled',
                        data: [{{$totalCanceledAmountM}}]
                    }],
                    chart: {
                        type: 'bar',
                        height: 325,
