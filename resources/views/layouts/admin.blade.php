                ...
                <div class="section-menu-left">
                    <div class="box-logo">
                        <a href="{{route('admin.index')}}" id="site-logo-inner">
                            <img class="" id="logo_header_" alt="" src="{{asset('storage/images/logo/logo.png')}}"
                                data-light="{{asset('storage/images/logo/logo.png')}}" data-dark="{{asset('storage/images/logo/logo.png')}}">
                        </a>
                    ...
                    <div class="header-dashboard">
                        <div class="wrap">
                            <div class="header-left">
                                <a href="index-2.html">
                                    <img class="" id="logo_header_mobile" alt="" src="{{asset('storage/images/logo/logo.png')}}"
                                        data-light="{{asset('storage/images/logo/logo.png')}}" data-dark="images/logo/logo.png"
